...
#pragma region Windows Form Designer generated code
		void InitializeComponent(void)
		{
			...
			this->txtBuscar->TextChanged += gcnew System::EventHandler(this, &FormRepuestos::txtBuscar_TextChanged);
			this->txtBuscar->KeyDown += gcnew System::Windows::Forms::KeyEventHandler(this, &FormRepuestos::txtBuscar_KeyDown);
